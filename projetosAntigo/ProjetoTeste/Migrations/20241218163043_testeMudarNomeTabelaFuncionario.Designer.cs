...
namespace ProjetoTeste.Migrations
{
    ...
    [Migration("20241218163043_testeMudarNomeTabelaFuncionario")]
    partial class testeMudarNomeTabelaFuncionario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Funcionario.Funcionario", b =>
                {
                    ...
                    b.HasAlternateKey("idFuncao");

                    b.ToTable("TesteSnakeCase", (string)null);
                });
